...
from app.routes.segmentationi_analysis import router as analysis_router
from app.routes.change_detection import router as change_detection_router
from app.routes.ndvi_analysis import router as ndvi_analysis_router
from app.utils.jwt import get_current_user


router = APIRouter()
router.include_router(auth_router)
router.include_router(ndvi_analysis_router, dependencies=[Depends(get_current_user)])
